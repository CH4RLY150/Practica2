...
try:
	...
	if orden == "create":
		...
		try:
			...
			parametros = "2"
		with open("numero.txt", "w") as fich:
			fich.write(parametros)
		...
		networkconfig.networkconfig(db, n_db)
		start.start(db, n_db)
		time.sleep(5)
		...
		networkconfig.networkconfig(s, parametros)
		...
		networkconfig.networkconfig(lb, n_bridges)
		# creación de los clientes
		crear.crear(c1, imagen, n_c1)
		networkconfig.networkconfig(c1, n_c1)
		print("created!")
